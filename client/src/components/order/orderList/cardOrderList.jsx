        ...
        <table className="items-center w-full border-collapse">
          ...
          <tbody className="bg-slate-300">
            <tr className="even:bg-white odd:bg-slate-200">
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4">
                <input
                  ...
                  name=""
                  id=""
                  className="w-3 h-3 ease-soft text-base"
                />{" "}
                <a className="text-indigo-600 cursor-pointer hover:text-indigo-400">
                  #kw12312
                </a>
              </td>
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4">
              ...
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4">
                <p className="text-slate-500">
                  Aug 23, 2023 <span className="text-xs">4:14</span>
                </p>
              ...
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
                <span className="px-5 py-2 rounded-md bg-red-200 text-red-500">
                  Paid
                </span>
              </td>
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
              ...
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
                <span className="px-5 py-2 rounded-md bg-green-200 text-green-600">
                  Shipped
                </span>
              </td>
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
                <button className="text-xl px-5 py-2 rounded-md bg-green-200 hover:bg-green-300 text-green-600">
                  <AiOutlineEdit />
                </button>{" "}
                <button className="text-xl px-5 py-2 rounded-md bg-red-200 hover:bg-red-300 text-red-500">
                  <AiOutlineDelete />
                </button>
              </td>
            </tr>
            ...
            <tr className="even:bg-white odd:bg-slate-200">
              ...
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
                <span className="px-5 py-2 rounded-md bg-yellow-200 text-yellow-600">
                  Cash on Delivery
                </span>
              </td>
              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm text-center whitespace-nowrap p-4">
